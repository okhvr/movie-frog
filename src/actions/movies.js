...
export const searchActionCreatorAsync = () => {
...
export const searchQueryChangedActionCreatorAsync = (query) => {
  return (dispatch) => {
...
export const searchOptionSelectedActionCreatorAsync = (query) => {
  return (dispatch) => {
...
export const sortOptionSelectedActionCreatorAsync = (option) => {
  return (dispatch) => {
...
export const searchMovieActionCreatorAsync = (id) => {
  return dispatch => {
    return getMovie(id).then(
