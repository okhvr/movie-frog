...
import { SORT_OPTION_SELECTED, sortOptionSelectedActionCreatorAsync, SEARCH_MOVIES_LOADING, SEARCH_MOVIES_COMPLETED, SEARCH_MOVIES_FAILED, searchQueryChangedActionCreatorAsync, SEARCH_QUERY_CHANGED, searchOptionSelectedActionCreatorAsync, SEARCH_OPTION_SELECTED, CLEAR_MOVIES, clearMoviesActionCreator, CLEAR_SEARCH, clearSearchQueryActionCreator, SEARCH_MOVIE_COMPLETED, searchMovieActionCreatorAsync } from './movies';
